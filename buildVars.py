...
addon_info = AddonInfo(
	...
	addon_changelog=_("Added lyrics lookup and saving, track announcements, sleep timer status, volume controls and fade out, looping bookmarks, and more flexible track seeking. Improved Now Playing information and SiriusXM channel reporting."),
